...
module.exports = {
  getPaises: function getPaises(callback) {
  ...
  registroUsuario: function registroUsuario(data, callback) {
    ...
    var usuario = [data.usuario, data.nombres, data.apellidos, data.sexo, data.fechaNacimiento, data.pais, data.correo, data.clave, data.telefono];
